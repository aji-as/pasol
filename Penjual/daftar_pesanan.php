        ...
        <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition duration-300 transform hover:-translate-y-1 overflow-hidden border border-gray-100 flex flex-col">
            ...
            <div class="p-4  flex flex-col justify-between">
                ...
                <div class="flex justify-between items-center pt-3 border-t border-gray-100 mt-auto">
                    ...
                    <a href="./?page=detail-order&id=<?php echo $order['id']?>" class="bg-green-600 text-white font-medium text-sm px-4 py-2 rounded-lg hover:bg-green-700 transition shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-green-500">
                        Lihat Detail
                    </a>
                </div>
            </div>
