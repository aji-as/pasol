...
if ($_POST['simpan']) {
    ...
    $result = create_user($nama_lengkap,$no_hp,$password,$email,"penjual",$alamat_blok);
    if($result){
...
<div class="max-w-5xl mx-auto p-4 md:p-8 bg-gray-50 min-h-screen font-sans">
    ...
    <div class="flex items-center gap-4 mb-8">
        <a href="./?page=daftar-penjual" class="p-2 bg-white rounded-lg border border-gray-200 text-gray-600 hover:bg-gray-100 transition shadow-sm">
            ...
            <div class="space-y-6">
                <div class="bg-white p-6 md:p-8 rounded-xl shadow-md border border-gray-100 h-full flex flex-col justify-between">
                    ...
                    <div class="flex items-center justify-end gap-4 pt-8 mt-4 border-t border-gray-100">
                        <a href="./?page=daftar-penjual" class="px-6 py-3 rounded-lg text-gray-600 font-semibold hover:bg-gray-100 transition">
                            Batal
                        </a>
