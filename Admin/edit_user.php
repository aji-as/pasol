...
if ($_POST['simpan']) {
    ...
    $result = edit_user($id, $nama_lengkap,$no_hp,$password,$email,$role,$alamat_blok);
    if($result){
...
<div class="max-w-5xl mx-auto p-4 md:p-8 bg-gray-50 min-h-screen font-sans">
     <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Edit Pengguna</h2>
            <p class="text-sm text-gray-500">Perbarui informasi akun Pembeli</p>
        </div>
    </div>
            ...
            <div class="space-y-6">
                <div class="bg-white p-6 md:p-8 rounded-xl shadow-md border border-gray-100 h-full">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="nama_lengkap" placeholder="Contoh: Alfiana Putri"  
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="no_hp" placeholder="0812..."  
                    ...
                    <div class="mb-2">
                        ...
                        <textarea name="alamat_blok" rows="4" placeholder="Contoh: Blok A5 No. 12, Perumahan Griya Indah"  
                                  class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 transition text-gray-700 resize-none bg-gray-50 focus:bg-white"><?php echo ($user['alamat_blok']); ?></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white p-6 md:p-8 rounded-xl shadow-md border border-gray-100 h-full flex flex-col justify-between">
                    <div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="relative">
                                 <select name="role"   class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 appearance-none bg-gray-50 focus:bg-white text-gray-700 cursor-pointer">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="password" name="password" id="passwordInput" value="<?php $user['password'] ?>" readonly
                            ...
                            <p class="text-xs text-gray-400 mt-1 ml-1">Kosongkan jika tidak ingin mengubah password.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-4 pt-8 mt-4 border-t border-gray-100">
                        ...
                        <input value="Update Data"  type="submit" name="simpan" class="px-8 py-3 bg-green-600 text-white rounded-lg font-bold shadow-lg hover:bg-green-700 hover:shadow-xl transform hover:-translate-y-0.5 transition duration-200 flex items-center gap-2">
                    </div>
                </div>
            </div>
